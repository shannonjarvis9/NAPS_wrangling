...
National Air Pollution Surveillance Program (NAPS) ([EC NAPS Data](https://data.ec.gc.ca/data/air/monitor/national-air-pollution-surveillance-naps-program/Data-Donnees/?lang=en)). As of May 5, 2021, the data for 2020 has not be uploaded. 
...
different sampler types (spectation, dichotomus and PM 2.5 air). Hovering over
a bar will display the name of the sampler. 
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width=8, fig.cap="Figure 1: Timelime of station samplers"}
library(plotly)
library(vistime)
...
figSpec <- vistime(vis1, col.group = "city", 
...
figDichot <- vistime(dich , col.group = "city", 
                     col.event = "type", show_labels = FALSE, col.color = "colour", 
                     col.tooltip = "Sampler", optimize_y = TRUE)
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Figure 2: Total $PM_{2.5}$ mass (Median, 25th and 75th percentile, 2nd and 98th percentile)"}
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
# Figure 2 
#------------------------------------------------------------------------------
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height= 8, fig.cap = "Figure 3: Monthly mean $PM_{2.5}$ (Mean and 90th percent CI)"}
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Figure 4: Mean Organic Carbon by cartridge and site"}
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
# Figure 4
#------------------------------------------------------------------------------
...
```{r, echo = FALSE, message = FALSE,  warning = FALSE, fig.height = 5, fig.cap = "Figure 5: Reconstructed $PM_{2.5}$ mass by compound mean"}
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
fig5_summer_before <- ggplot(comp_station_april_sept_before, mapping = aes(x = city, y = val, 
  ...
  theme(axis.text=element_text(size=6.3), legend.text=element_text(size=7),
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Figure 6: Reconstructed $PM_{2.5}$ mass by mean compound for the 10 hightest mass concentration days"}
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height= 8, fig.cap = "Figure 7: Ammonium sulphate and ammonium nitrate concentrations by site and month (mean and inter-quartile range)" }
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
### Figure 8: Median elemental carbon (EC) and organic matter (OM) concentrations by site and month 


```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 8, fig.cap = "Figure 8: Elemental carbon (EC) and organic matter (OM) by site and month (mean and inter-quartile range)"}
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
# Figure 8: EC and OC
#------------------------------------------------------------------------------
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 8 , fig.cap = "Figure 9: Soil and sodium chloride concentrations by site and month (mean and inter-quartile range)"}
#------------------------------------------------------------------------------
#------------------------------------------------------------------------------
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height = 6 , fig.cap = "Figure 10a:  Ammonia mixing ratio by site and month (mean and inter-quartile range)"}
...
fig10_after <- ggplot(data = ammonia_compnd_after %>% filter(city != "Abbotsford"),
  ...
  facet_wrap(~ city, nrow = 3) + 
  scale_y_continuous(limits = c(0, 6), breaks = 0:6) + 
  labs(y = "Ammonia (ppb)", x = "Month",  title = "July 2010 - 2019")  + 
  scale_x_discrete(labels= c("J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"))

ggarrange(fig10_before, fig10_after,  ncol=2,nrow = 1)
```

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height= 2, fig.width = 4 , fig.cap = "Figure 10b:  Ammonia mixing ratio for Abbotsford by month (mean and inter-quartile range)"}

fig10_abbosford_after <- ggplot(data = ammonia_compnd_before %>% filter(city == "Abbotsford"), 
       mapping = aes(x = month_text, y = Ammonia,group = 1, ymin = lwr_quantile, ymax = upr_quantile)) + 
  geom_point() + 
  geom_line() +
  geom_errorbar() +
...
fig10_abbosford_before <- ggplot(data = ammonia_compnd_after %>% filter(city == "Abbotsford"), 
       mapping = aes(x = month_text, y = Ammonia,group = 1, ymin = lwr_quantile, ymax = upr_quantile)) + 
  geom_point() + 
  geom_line() +
  geom_errorbar() +
...
abb <- ggarrange(fig10_abbosford_after,fig10_abbosford_before, ncol=2,nrow = 1)
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height= 8 , fig.cap = "Figure 11: Sulphr dioxide mixing ratio and nitric acid concentrations by site and month (mean and inter-quartile range)"}
