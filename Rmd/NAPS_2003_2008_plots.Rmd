...
png(file = paste0(wd$figure,"pm_by_site_2003_2008.png"), width = 480, height = 480)
figurepm
...
Sulphur_nitric_dat_before <- get_Sulphur_Nitric(spec_before_cutoff)


# lets plot! 
fig_so2_nitric <- ggplot(data = Sulphur_nitric_dat_before,
  ...
  scale_y_continuous(limits = c(0, 14), breaks = seq(0,14,2),
                     expression(paste("Sulphur Dioxide (",mu ,"g/",m^3,")")), 
